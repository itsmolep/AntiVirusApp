...
namespace AntiVirusApp.Utils
{
	sealed class SystemIconManager //用于实时更新浏览器界面的图标，例如磁盘、文件夹的图标不同
	{
		...
		[DllImport("shell32")]
		private static extern int SHGetFileInfo(string pszPath, uint dwFileAttributes, out SHFILEINFO psfi, uint cbFileInfo, uint flags); //机器固定路径
